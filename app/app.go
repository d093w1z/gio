...
//
// ID is set by the [github.com/d093w1z/gio/cmd/gogio] tool or manually with the -X linker flag. For example,
//
//	go build -ldflags="-X 'github.com/d093w1z/gio/app.ID=org.gioui.example.Kitchen'" .
//
