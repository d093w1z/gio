...
of a user interface and is exposed by [github.com/d093w1z/gio/app.FrameEvent]
received from windows.

The [Router] is used by [github.com/d093w1z/gio/app.Window] to track window state and route
